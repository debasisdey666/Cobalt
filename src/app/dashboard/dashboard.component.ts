...
export class DashboardComponent implements OnInit {
  ...
  constructor(
    private serviceData: DashboardService,
    private router: Router,) { }

    selectedMISReport: any;
  showAttend: any;
  showAtnd: any;
  ROLE_ID: any;
  showNoticeEvent: any;
  ...
  ngOnInit(): void {
    ...
    this.serviceData.showInstructor().subscribe((data) => {
      ...
      this.showInstrctr = this.showInstructor['INSTRUCTOR_COUNT'][0].TOTAL_INSTRUCTOR;
      console.log("this.showInstrctr");
      console.log(this.showInstrctr);
    });
    this.serviceData.showStudent().subscribe((data) => {
      this.showStudentall = data;
      this.showStudnt = this.showStudentall['STUDENT_COUNT'][0].TOTAL_STUDENTS;
