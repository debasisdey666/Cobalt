...
export class StudentListComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.serviceData.showStudentlist().subscribe((data) => {
      ...
      this.studentCount = this.showStudent.length; // Calculate the student count here
  ...
  exportToExcel(): void {
    const ws: XLSX.WorkSheet = XLSX.utils.json_to_sheet(this.showStudent);
  ...
  searchStudentListdata(data:any){
    console.log(data);
    this.serviceData.searchStudentlist(data).subscribe((data) => {
      this.showStudentData = data;
      this.showStudent =  this.showStudentData['Data'];
      this.studentCount = this.showStudent.length; // Calculate the student count here
      console.log(this.showStudent);
