...
searchFilters: { [key: string]: string } = {};
  ...
  constructor(
    ...
    private serviceData5: ProfileService,
  ...
  ngOnInit(): void {
    ...
    this.serviceData5.showStudentDetails().subscribe((data) => {
      this.showStudentData = data;
      this.showStudent =  this.showStudentData['Data'];
      this.studentNm = this.showStudent[0].STUDENT_NAME;
      this.studentId = this.showStudent[0].ID;
      this.regNo = this.showStudent[0].STUDENT_REGISTRATION;
