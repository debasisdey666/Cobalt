...
export class AttendanceComponent implements OnInit { 
  ...
  ngOnInit(): void {
    ...
    this.serviceData.showMonthYear().subscribe((data) => {
      this.showMonthYr = data;
      this.showMntyr = this.showMonthYr['ATTENDANCE_DETAILS'];
      // console.log("Student Attendance");
      console.log("this.showMonthYr");
      console.log(this.showMntyr[0].FilterMonthName);
    }) 
