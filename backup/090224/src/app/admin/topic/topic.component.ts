...
export class TopicComponent implements OnInit {
  ...
  @ViewChild('getTopicForm') getTopicForm!: NgForm;
  @ViewChild('topicFormedit') topicFormedit!: NgForm;
  ...
  // Serach filter Start
   ...
   updateFilteredItems() {
    if (Object.values(this.searchFilters).some(filter => !!filter)) {
      this.filteredItems = this.showTopc.filter((item:any) =>
      ...
      this.filteredItems = this.showTopc.slice();
    }
